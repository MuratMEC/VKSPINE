...
import { Building2, Save, X, Loader2, AlertCircle, ArrowLeft } from 'lucide-react';
import { useRouter, useParams } from 'next/navigation';
import Link from 'next/link';

export default function TedarikçiDüzenlePage() {
    ...
    useEffect(() => {
        const fetchSupplier = async () => {
            try {
                ...
                if (!res.ok) throw new Error('Tedarikçi bilgileri yüklenemedi.');
    ...
    if (isLoading) {
        return (
            <div className="max-w-4xl mx-auto px-4 py-12 flex flex-col items-center justify-center">
                ...
                <p className="text-slate-500 font-medium">Tedarikçi bilgileri hazırlanıyor...</p>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="mb-8 flex items-center justify-between">
                <div>
                    <Link href="/tedarikciler" className="text-blue-600 hover:text-blue-800 flex items-center gap-1 text-sm font-medium mb-2">
                ...
                <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2 md:col-span-2">
                            <label className="text-sm font-semibold text-slate-700">Firma Ünvanı *</label>
                            <input
                                required
                                type="text"
                                ...
                                placeholder="Örn: Meditera Medikal A.Ş."
                            />
                        </div>
